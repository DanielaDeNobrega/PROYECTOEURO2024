...
def setting_equipos_all(): 
    """Agarrar la información de la API y saca la base de datos de los equipos. 
    ...
    for equipo in json_equipos: 
        team = Team(equipo["id"], equipo["code"], equipo["name"] , equipo["group"])
...
def setting_matches_all(equipos_all, stadiums_all, ):
    """Crea la base de datos de los partidos. 
